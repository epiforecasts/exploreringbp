      ...
      f7Col(    
        ...
        f7Card(title = "Outbreak settings",
               ...
               f7Slider(ns("dispcommunity"),
                        label = "Dispersion of the reproduction no. in the community:",
                        min = 0, 
                        max = 4,
                        value = 0.16,
                        step = 0.01),
               ...
               f7Slider(ns("dispisolation"),
                        label = "Dispersion of the reproduction no. in those isolated:",
                        min = 0, 
                        max = 4,
                        value = 0.16,
                        step = 0.01),
               br(), br(),
               f7BlockHeader("Proportion of tranmission prior to symptom onset:"),
               f7Radio(ns("theta"), 
                       label = "", 
                       choices = c("<1%",
                                   "15%",
      ...
      f7Col(
        f7Card(title = "Control settings",
               f7Slider(ns("prop.ascertain"),
                        ...
                        step = 0.01),
               br(),
               f7BlockHeader("Delay from onset to isolation:"),
               f7Radio(ns("delay"), 
                       label = "", 
                       choices = c("Short", 
                                   "Long"),
